...
<div class="table-container">
    <h1>LISTADO DE USUARIOS</h1>
        <div class="contenido1">    
            <a href="movimientos.php">
                <button class="btn_1"><i class="fa-solid fa-table"></i>
                Movimientos
                </button>
            </a>
        </div>
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td data-label=""> <a href="reporte.php"><button class="btn_3"><i class="fa-regular fa-pen-to-square"></i></button></a></td>
                    <td data-label=""> <a href="reporte.php"><button class="btn_2"><i class="fa-solid fa-user-minus"></i></button></a></td>
                </tr>
            <?php  }
                    } else {
